// src/controllers/category.test.ts
...
const mockRes = () => mockDeep<Response>({ status: jest.fn().mockReturnThis() });

describe('getCategories', () => {
  const findAll = Category.findAll as jest.MockedFunction<typeof Category.findAll>;
