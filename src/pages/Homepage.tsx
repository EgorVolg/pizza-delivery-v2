...
const pizzas = [
  ...
  },
  {
    ...
    name: "Four Cheese",
    description:
      "Four cheeses (mozzarella, cheddar, provolone, and parmesan) on a classic tomato base. Four cheeses (mozzarella, cheddar, provolone, and parmesan) on a classic tomato base. ",
    price: 11.99,
  },
  {
    id: 22,
